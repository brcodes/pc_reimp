...
class SpccParameters(object):
    ...
    input_size = attr.ib(default=864,validator=attr.validators.instance_of(int))
    # First element in hidden_sizes is the size of only one single layer 1 module
    # If tiled data input into model, sum of all layer 1 module params becomes hidden_sizes[0] * numtiles (Li 5natimg case: 32*225: 7200) Li 212 case: 32*16=512
    hidden_sizes = attr.ib(default=[512,128],validator=attr.validators.instance_of(list))
    ...
    k_r_sched = attr.ib(kw_only=True,default={'constant':{'initial':0.001}},validator=attr.validators.instance_of(dict))
    k_U_sched = attr.ib(kw_only=True,default={'constant':{'initial':0.001}},validator=attr.validators.instance_of(dict))
    ...
    sigma_sq = attr.ib(default={1: 1.0, 2: 10.0, 3: 10.0, 4: 2.0, 5: 10.0, 6: 10.0, 7: 10.0, 8: 10.0, 9: 2.0},validator=attr.validators.instance_of(dict))
    ...
    lam = attr.ib(default={1: 0.001, 2: 0.001, 3: 0.001, 4: 0.00001, 5: 0.00001, 6: 0.00001, 7: 0.00001},validator=attr.validators.instance_of(dict)) #" related to variance of Gaussian priors "
...
#     # First element in hidden_sizes is the size of only one single layer 1 module
#     # If tiled data input into model, sum of all layer 1 module params becomes hidden_sizes[0] * numtiles (Li 5natimg case: 32*225: 7200) Li 212 case: 32*16=512
#     hidden_sizes = attr.ib(default=[7200,128],validator=attr.validators.instance_of(list))
