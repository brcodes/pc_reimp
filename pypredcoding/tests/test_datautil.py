...
class TestDataUtil(unittest.TestCase):
    ...
    def test_mnist_read(self):
        ...
        size-wise.
        '''
        self.assertEqual(self.X.shape,(60000,28,28))
        self.assertEqual(self.y.shape,(60000,10))
    ...
    def test_flatten(self):
        ...
        self.assertEqual(flat_X.shape,(60000,28*28))
    ...
    def test_inflate(self):
        ...
        self.assertEqual(inf_y.shape,(60000,5,2))
